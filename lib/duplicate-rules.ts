...
/** The five situations, numbered as the brief numbers them. */
export type DuplicateCase = 1 | 2 | 3 | 4 | 5;
 ...
 */
export type DuplicateAction = "new_enquiry" | "touch" | "return" | "decide";
...
export function caseOf(state: NumberState): DuplicateCase {
  switch (state) {
    case "new":
      return 1;
    case "resolved":
 ...
 */
export function describeNumber(status: NumberStatus): DuplicateVerdict {

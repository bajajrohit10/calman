          ...
          <table className="w-full min-w-[900px] border-collapse text-[12.5px]">
            <thead>
              <tr className="border-b border-line bg-sunk/40 text-left text-[11px] uppercase tracking-wider text-ink-3">
                ...
                <th className="px-2 py-2">Last called by</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r) => (
                ...
                >
                  ...
                  <td className="max-w-[280px] truncate px-2 py-1.5 text-ink-3">
                    {r.last_discussion ?? "—"}
                  </td>
                  <td className="px-2 py-1.5 text-ink-3">{r.last_caller_name ?? "—"}</td>
                </tr>
              ))}
              {rows.length === 0 ? (
                <tr>
